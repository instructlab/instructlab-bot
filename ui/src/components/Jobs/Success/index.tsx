...
const SuccessJobs: React.FunctionComponent = () => {
  ...
  const successJobs = React.useMemo(() => {
    const filteredJobs = jobs.filter((job) => job.status === 'success');
    ...
    <JobsLayout>
      <PageSection>
        <Title headingLevel="h1" size="lg">
          Successful Jobs - <em>Click to Expand Details</em>
        </Title>
